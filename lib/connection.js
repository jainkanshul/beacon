...
const con = mysql.createConnection({
  host: "fujibeacondatabase.mysql.database.azure.com",
  user: "beacondatabase@fujibeacondatabase",
...
let createpunch =  `create table if not exists punches(
  id int primary key auto_increment,
  beaconId varchar(255)not null,
 ...
 con.query(createpunch, function(err, results, fields) {
  if (err) throw err;
    console.log("punch Table created if not exist ");
